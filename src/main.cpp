...
uint256 hashGenesisBlock("0x25fdce61090e78d8f0028ee2edd2fb18fd7a36f153ee81581bdf6e9aa97e7cbd");
...
const string strMessageMagic = "nazigold Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // nazigold: 0.35 days
static const int64 nTargetSpacing = 88; // 88 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal nazigold miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "nazigold", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x648779ae0094882bc111e6fec750785e9a7ce2e4f23aa007745d4515f6de041f");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "http://krautchan.net/b/thread-6956501.html - der fuehrer ist erfreut";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1387817647;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1387817647;

        if (fTestNet)
        {
            block.nTime    = 1387817647;
            block.nNonce   = 386580325;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xfd6325f1190f9a757b5cd72ea3125fccbf34c3d944659c18166feeff1cc250d3"));
